...
import 'package:carea_app/features/food/presentation/widgets/ingredients_list.dart';
import 'package:carea_app/features/food/presentation/widgets/instructions_list.dart';
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ProductsDetailsImage(imageUrl: widget.recipe.image),
            const SizedBox(height: 30),
            ProductsDetailsInfo(
              name: widget.recipe.name,
              cookTime: widget.recipe.cookTimeMinutes,
            ),
