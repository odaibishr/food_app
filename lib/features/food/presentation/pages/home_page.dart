...
import 'package:carea_app/features/food/presentation/widgets/product_card.dart';
import 'package:carea_app/features/food/presentation/widgets/section_title.dart';
          ...
          child: Column(
            children: [
              ...
              Align(
                ...
                child: Text('Enjoy Delicious food', style: TextStyles.header1),
              ),
              SizedBox(height: 20),
              Categories(),
              SizedBox(height: 15),
      ...
      children: [
        GestureDetector(
          ...
          child: Container(
            ...
            child: SvgPicture.asset("assets/icons/drawer-icon.svg", height: 15),
          ),
        ),
        const SizedBox(width: 16),
        const Text("Home", style: TextStyles.header3),
...
class _CategoriesState extends State<Categories> {
  ...
  List<Map<String, dynamic>> categories = [
    {"icon": flashIcon, "text": "Pizza"},
    {"icon": billIcon, "text": "Burger"},
...
class _PopularSectionState extends State<PopularSection> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        SectionTitle(title: "Popular restaurants", press: () {}),
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    return ProductCard(
                      ...
                      category: state.recipes[index].name,
                      numOfBrands: state.recipes[index].reviewCount,
                      press: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
